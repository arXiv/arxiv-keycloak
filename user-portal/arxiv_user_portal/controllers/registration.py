...
from arxiv.auth.legacy.exceptions import RegistrationFailed, SessionCreationFailed, SessionDeletionFailed
...
def register(method: str, params: MultiDict, captcha_secret: str, ip: str,
    ...
    if method == 'GET':
        ...
        # })
        return data, HTTPStatus.SEE_OTHER.value, {'Location': next_page}
...
def edit_profile(method: str, user_id: str, session: domain.Session,
    ...
    if method == 'GET':
        ...
        try:
            ...
            return data, HTTPStatus.INTERNAL_SERVER_ERROR.value, {}
        ...
        # }})
        return data, HTTPStatus.SEE_OTHER.value, {}
    return data, HTTPStatus.OK.value, {}
...
class ProfileForm(FlaskForm):
    ...
    GROUPS = [
        ...
        if hasattr(group, 'is_test') and group.is_test
    ]
    CATEGORIES = [
        (archive.full_name, [
...
class RegistrationForm(FlaskForm):
    ...
    def validate_password(self, _field: StringField) -> None:
